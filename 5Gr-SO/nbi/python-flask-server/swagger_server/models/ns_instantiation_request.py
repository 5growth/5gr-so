...
class NsInstantiationRequest(Model):
    ...
    def __init__(self, flavour_id: str=None, ns_instantiation_level_id: str=None, service_type: str=None, sap_data: List[SapDataIm]=None, pnf_info: List[PnfInfoIm]=None, vnf_instance_data: List[VnfInstanceDataIm]=None, nested_ns_instance_id: List[str]=None, location_constraints: List[VnfLocationConstraintIm]=None, additional_param_for_ns: Dict[str, str]=None, additional_param_for_vnf: List[ParamsForVnfIm]=None, start_time: str=None, additional_affinity_or_anti_affinity_rule: List[AffinityOrAntiAffinityRuleIm]=None):  # noqa: E501
        ...
        :param service_type: The service_type of this NsInstantiationRequest.  # noqa: E501
    ...
    def service_type(self) -> str:
        """Gets the service_type of this NsInstantiationRequest.


        :return: The service_type of this NsInstantiationRequest.
        :rtype: str
        """
    ...
    def service_type(self, service_type: str):
        """Sets the service_type of this NsInstantiationRequest.


        :param service_type: The service_type of this NsInstantiationRequest.
        :type service_type: str
        """
        allowed_values = ["eMBB", "uRLLC", "mMTC"]  # noqa: E501
