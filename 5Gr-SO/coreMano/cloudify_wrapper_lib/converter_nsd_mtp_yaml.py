...
config_mon = RawConfigParser()
config_mon.read("../../monitoring/monitoring.properties")
monitoring_ip = config_mon.get("MONITORING", "monitoring.ip")
monitoring_port = config_mon.get("MONITORING", "monitoring.port")
monitoring_base_path = config_mon.get("MONITORING", "monitoring.base_path")
monitoring_pushgateway = config_mon.get("MONITORING", "monitoring.pushgateway")
...
class ConverterNSDMTPYAML(object):
    def __init__(self):
        ...
        self.__install_rvm_agent = "no"
        self.__additional_param_for_ns = None
        self.__map_vm_agent_id = {}
        self.__vnf_deployed_info_dict = {}

    def get_agent_ids(self):
        return self.__map_vm_agent_id
    ...
    def install_rvm_agent(self, install_rvm_agent):
...
#                                   find network by port
    ...
    def generate_yaml(self, file_name):
        ...
        for server_name, server in self.servers.items():
            ...
            self.__map_vm_agent_id.update({server_name: agent_id})
...
#                   generate output object
    ...
    def set_vnf_deployed_info(self, db_vnf_deployed_info):
        self.__vnf_deployed_info_dict = {}
        if  db_vnf_deployed_info is not None:
            for vnf_deployed_info in db_vnf_deployed_info:
                self.__vnf_deployed_info_dict.update({vnf_deployed_info["name"]: vnf_deployed_info})
...
class Server(object):
    ...
    def get_yaml(self):
        ...
        yaml = "  " + self.__name + ":\n" \
            ...
            "        resourceGroupId: \"\"\n" \
            "        userData: \n" \
            "          content: " + self.__user_data_content + "\n" \
            "          method: CONFIG-DRIVE\n" \
    ...
    def create_rvm_agent(self, agent_id=None, install_method="", description="", daemon_user=""):
        ...
        try:
            ...
            rvm_agent_info = json.loads(rvm_agent_info)
    ...
    def add_spaces(self, number_of_spaces, user_data_content):
        return_user_data_content = " |\n" + " " * number_of_spaces
        return_user_data_content = return_user_data_content + user_data_content.replace("\n", "\n" + " " * number_of_spaces)
        return return_user_data_content
